...
// get profile
$site_profile = basename(glob(DRUPAL_ROOT . '/profiles/*_profile', GLOB_ONLYDIR)[0]);

// get subscription
$sub = str_replace('_profile', '', $site_profile);

//  load settings file for local development
$local_settings_file = DRUPAL_ROOT . "/sites/default/settings.local.php";
...
// set config that must not be exported and imported.
$config_blacklist = [
  'acquia_*.settings',
...
$config_sync_folder = "profiles/$site_profile/config/sync";
...
//set error reporting level to hide all errors and warnings
$config['system.logging']['error_level'] = ERROR_REPORTING_HIDE;

//enable CSS and JS aggregation files
$config['system.performance']['css']['preprocess'] = TRUE;
$config['system.performance']['js']['preprocess'] = TRUE;

$settings['config_sync_directory'] = $config_sync_folder;
